                ...
                <div>
                    ...
                    <div className='space-y-4'>
                        ...
                        <div>
                            ...
                            <p className='mt-1 text-gray-900 font-medium'>
                                {storeData.products?.filter((p) => p.status === 'active').length ||
                                    0}
                            </p>
                        </div>
                        <div>
                            ...
                            <p className='mt-1 text-gray-900 font-medium'>
                                {storeData.products?.filter((p) => p.status === 'pending').length ||
                                    0}
                            </p>
                        </div>
                    </div>
                        ...
                        <div key={index} className='bg-white rounded-lg shadow-sm p-6'>
                            ...
                            <div className='flex justify-between items-center'>
                                ...
                                <button
                                    onClick={() =>
                                        navigate(
                                            `/profile/store-owner-application/edit-product/${product.id}`
                                        )
                                    }
