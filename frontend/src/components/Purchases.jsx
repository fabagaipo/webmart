        ...
        <div className="flex items-center justify-end mb-8 space-x-4">
          <div className="relative">
            <input
              ...
              className="px-3 py-1.5 rounded-lg border text-black border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 w-48 pr-8"
            />
          ...
          <select 
            className="px-4 py-2 rounded-lg border text-gray-500 border-gray-300 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
            value={statusFilter}
