        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-4">
            ...
            <div className="flex items-center space-x-8">
              ...
              <Link to="/profile" className="flex flex-col items-center text-sm text-gray-800 hover:text-blue-600">
                <FaUser className="text-xl mb-1" />
              </Link>
              <Link to="/cart" className="flex flex-col items-center text-sm text-gray-800 hover:text-blue-600 relative">
