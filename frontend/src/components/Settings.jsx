            ...
            <div className="flex items-center space-x-4">
              <label className="flex items-center">
                <input
                  ...
                  onChange={(e) => handleSettingsChange('notifications', { ...settingsData.notifications, email: e.target.checked })}
            ...
            <div className="flex items-center space-x-4">
              <label className="flex items-center">
                <input
                  ...
                  onChange={(e) => handleSettingsChange('notifications', { ...settingsData.notifications, sms: e.target.checked })}
                  className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded"
                />
            ...
            <div className="flex items-center space-x-4">
              <label className="flex items-center">
                <input
                  ...
                  onChange={(e) => handleSettingsChange('notifications', { ...settingsData.notifications, push: e.target.checked })}
                  className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded"
                />
