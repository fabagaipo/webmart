                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-16'>
                    ...
                    <div>
                        ...
                        <p className='text-gray-600 mb-6'>
                            WebMart was founded with a vision to make shopping accessible and
                            convenient for everyone. We believe in providing quality products at
                            competitive prices while maintaining excellent customer service.
                        </p>
                        <div className='space-y-4'>
                            ...
                            <div className='flex items-center'>
                                ...
                                <div className='ml-4'>
                                    ...
                                    <p className='text-gray-600'>
                                        To be the leading e-commerce platform in the region.
                                    </p>
                                </div>
                            </div>
                            <div className='flex items-center'>
                                ...
                                <div className='ml-4'>
                                    ...
                                    <p className='text-gray-600'>
                                        Customer satisfaction, innovation, and integrity.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <div className='space-y-6'>
                            <div className='flex items-center'>
                                ...
                                <div className='ml-4'>
                                    <p className='text-gray-600'>
                                        123 Shopping Street, Metro Manila, Philippines
                                    </p>
                                </div>
                            </div>
                            <div className='flex items-center'>
